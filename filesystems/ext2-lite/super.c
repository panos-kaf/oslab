...
static int __init init_ext2_fs(void)
{
	...
	if (err){
		ext2_debug("Error registering ext2-lite. Destroying inode cache\n");
		destroy_inodecache();
		return err;
	}
	ext2_debug("ext2-lite registered succesfully\n");	
	return err;
}
...
static void __exit exit_ext2_fs(void)
{
	...
	if(err) ext2_debug("ext2-lite not found\n");
	destroy_inodecache();
	ext2_debug("ext2-lite module removed\n");
}
